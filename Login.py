...
# MongoDB connection
client = MongoClient("mongodb+srv://aryan:aryan205@cluster0.exl9wgf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    ...
    if (username == "" or username == "Username") or (password == "" or password == "Password"):
        ...
        try:
            ...
            if user_data is None:
                ...
                trial()  # Call trial function to track login attempts
            else:
                messagebox.showinfo("Login", "Successfully logged in!!!")
                root.destroy()
                import main  # Import your main application module
